...
[![Version](https://img.shields.io/badge/version-3.0.4-blue.svg)](https://github.com/myths-labs/muse/blob/main/CHANGELOG.md)
...
**Q: 支持哪些 AI 工具？**
七种工具原生安装支持：**Claude Code**、**OpenClaw**、**OpenCode**、**Cursor**、**Windsurf**、**Gemini CLI** 和 **Codex CLI**。运行 `./scripts/install.sh --tool <工具名>` 自动转换为对应格式安装。其他支持 Markdown 规则文件的工具也可手动配置。
