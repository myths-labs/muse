...
[![Version](https://img.shields.io/badge/version-3.2.2-blue.svg)](https://github.com/myths-labs/muse/blob/main/CHANGELOG.md)
...
**支持工具**: Claude Code · OpenClaw · OpenCode · Cursor · Windsurf · Gemini CLI · Codex CLI · Copilot · Aider · Antigravity — 以及任何支持 system prompt 的 AI 编程助手。
